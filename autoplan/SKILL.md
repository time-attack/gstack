...
preamble-tier: 3
version: 1.0.0
description: Auto-review pipeline — reads the full CEO, eng, and DX review skills from disk and runs them sequentially with auto-decisions using 6 decision principles. (gstack)
...
/autoplan reads the full CEO, eng, and DX review skill files from disk and follows
