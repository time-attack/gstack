...
**Web search:** Codex enables cached web search by default. Do not pass the
deprecated `--enable web_search_cached` feature toggle. Respect the user's
configured `web_search` mode; `--search` would override it to live browsing.
