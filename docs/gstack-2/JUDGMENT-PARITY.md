...
The pinned release inventory passes **5,631 checks** across 47 specialist sources, 14 carved sections, 19 routing scenarios, 31 regression ports, and **70 assets**.
...
- 47 canonical templates plus 14 carved section templates at base `bb57306d98c97011b0919c6132705a15b1579781`;
...
- 31 upstream judgment-port regression fixtures and anchors;
