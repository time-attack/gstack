...
The pinned release inventory passes **5,650 checks** across 47 specialist sources, 14 carved sections, 19 routing scenarios, 34 regression ports, and **70 assets**.
...
- 34 upstream judgment-port regression fixtures and anchors;
