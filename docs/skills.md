...
| [`/setup-search-mcp`](#setup-search-mcp) | **Search Setup** | Set up free web search for agents (Parallel Search MCP, no account or API key by default) so Search Before Building works. |
