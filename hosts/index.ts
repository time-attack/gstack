...
export const ALL_HOST_CONFIGS: HostConfig[] = [claude, codex, factory, kiro, opencode, slate, cursor, openclaw, hermes, gbrain, pi, agy, vibe, qoder, grokBuild];
...
export { claude, codex, factory, kiro, opencode, slate, cursor, openclaw, hermes, gbrain, pi, agy, vibe, qoder, grokBuild };
