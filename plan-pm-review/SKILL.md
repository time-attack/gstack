...
```bash
~/.claude/skills/gstack/bin/gstack-learnings-log '{"skill":"plan-pm-review","type":"TYPE","key":"SHORT_KEY","insight":"DESCRIPTION","confidence":N,"source":"SOURCE","files":["path/to/relevant/file"]}'
```
