...
Also apply the remaining INFORMATIONAL categories that are still in the checklist (Async/Sync Mixing, Column/Field Name Safety, LLM Prompt Issues, Type Coercion, View/Frontend, Time Window Safety, Completeness Gaps, Distribution & CI/CD, Script & Shell Quality, Platform & Convention Consistency, Configuration & Infrastructure Safety, MCP Server Packaging).
