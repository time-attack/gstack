...
// overlay for issue #538 (29 -> 30, office-hours only) added 5 more. Removing
// the /design skill then dropped eight source modules, six routing scenarios,
// two carved sections, and four design-only overlays (#696, #1777, #1920,
// #2189) while keeping #538, which recomputes the inventory to the value below.
export const EXPECTED_PARITY_CHECKS = 4341;
