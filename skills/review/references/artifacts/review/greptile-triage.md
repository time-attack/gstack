...
3. Cross-reference the comment against the full diff (`git diff <remote>/<base>`, using the remote and base branch detected earlier by `references/BASE-DETECTION.md`; never assume the remote is named `origin`) and the review checklist
4. Classify:
