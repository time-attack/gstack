...
_BRANCH=$(git branch --show-current 2>/dev/null || echo "unknown")
_PLAN_GLOB=$(~/.openclaw/skills/gstack/bin/gstack-config get plan_glob 2>/dev/null || echo "")
...
`~/.openclaw/skills/gstack/pr-prep/SKILL.md` (or the `pr-prep` skill wherever
