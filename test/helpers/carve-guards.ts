...
export const CARVE_GUARDS: Record<string, CarveGuard> = {
  ship: {
    ...
    // Security-wave merge: AUQ payload+shape rules (#1241/#2045) + learnings
    // feedback (#2030) grew the always-loaded preamble ~2.5KB on top of #2077;
    // measured union ratio on the merged tree: 1.091.
    maxSizeRatio: 1.11,
  },
  'plan-ceo-review': {
